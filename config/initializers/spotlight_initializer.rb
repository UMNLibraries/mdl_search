...
Spotlight::Engine.config.default_autocomplete_params = { qf: 'id^1000 title_tesi^100 id_ng title_ng' }
...
###
# Override Blacklight's route constraint for document IDs to allow
# for ":" in addition to word characters and dashes.
Blacklight::Engine.config.routes.identifier_constraint = /[:\w-]+/
